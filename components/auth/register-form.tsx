...
export function RegisterForm() {
  ...
  async function signUpWithGoogle() {
    ...
    // on success the page redirects away — no need to reset loading
  }
  ...
  async function onSubmit(data: RegisterInput) {
    ...
    try {
      ...
      // When email confirmation is required, Supabase returns an unconfirmed
      // user with an empty identities array — detect that here.
      ...
      if (needsEmailConfirmation) {
        ...
        // send straight to the onboarding wizard. No org is created here;
        // the wizard handles org creation, location, resources, plans, and payments.
      ...
      <div className="text-center space-y-6 py-4">
        ...
        <div>
          ...
          <p className="mt-2 text-gray-500">
            ...
            <br />
            Click it to activate your account — you&apos;ll then set up your space.
          </p>
